<div
    class="bravo-form-search-all slider-carousel hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2">
    <div class="effect ">
        <div class="owl-carousel">
            @foreach ($list_slider as $item)
                ...
                <div class="item"
                    ...
                    <div class="pb-10">
                        <h1 class="font-size-60 font-size-xs-30 text-white font-weight-bold">{{ $item['title'] ?? '' }}
                        </h1>
    ...
    <div class="container space-2 space-top-xl-4">
        @if (empty($hide_form_search))
            <div class="mb-lg-n1">
                <ul class="nav tab-nav-rounded flex-nowrap pb-2 pb-md-4 tab-nav @if (!empty($single_form_search)) d-none @endif"
                    role="tablist">
                ...
                <div class="tab-content hero-tab-pane">
                    @if (!empty($service_types))
                        ...
                        @foreach ($service_types as $service_type)
                            ...
                            @endphp
                            <div class="tab-pane fade @if ($number == 0) active show @endif"
                                id="bravo_{{ $service_type }}" role="tabpanel"
